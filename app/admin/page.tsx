...
import { Users, Calendar, Package, Anchor, TrendingUp, DollarSign, Inbox } from "lucide-react";
...
export default async function AdminDashboard() {
    ...
    const stats = [
        ...
        { name: "Boat", value: boatCount, icon: Anchor, color: "bg-orange-500" },
    ];
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                {recentBookings.length > 0 ? (
                    ...
                    <EmptyState
                        ...
                        description="New bookings will appear here once customers start making reservations."
                    />
                )}
            </div>
        </div>
